// TODO (vitest setup): este archivo está comentado porque vitest no está
// configurado en master al momento de este commit (2026-05-02). La sesión paralela
// de Deepgram está añadiendo vitest + vitest.config.ts; cuando aterrice en master,
// descomentar este archivo y verificar que los 7 tests pasen.
//
// Verifica el contrato del bloque <formato_valores_por_caja> contra CAJAS_CANON:
//   - 49 entradas exactas
//   - todos los códigos del XML están en CAJAS_CANON
//   - ningún código de CAJAS_CANON falta del XML
//   - cada entrada tiene los 5 sub-tags requeridos
//   - criticidad XML coincide con CAJAS_CANON (alta ↔ critica, blanda ↔ blanda)
//
// /* eslint-disable */
